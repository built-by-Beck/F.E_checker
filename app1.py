...
def reset_inspections():
    ...
    # Set all extinguishers' pass/fail status to 'Unchecked' and update the inspection date
    ...
    # Redirect back to the inspection page
    return redirect(url_for('check_extinguishers'))
